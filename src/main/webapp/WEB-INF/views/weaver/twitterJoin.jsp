	...
	$("#email").focusout(function() {
		var t = escape($("#email").val());
		  if(t.match(/^(\w+)@(\w+)[.](\w+)$/ig) == null && t.match(/^(\w+)@(\w+)[.](\w+)[.](\w+)$/ig) == null){
    		$("#email").tooltip({title: "올바른 이메일 주소를 입력해주세요!",trigger: 'manual',placement:"right"}).tooltip('show');
    		check = false;
    	    }else{
	...
	<div class="container">
		...
		<div class="span12">
			...
			<div class="span6">
				...
				<form id="signupform" onsubmit="return check" class="form-horizontal" action="/twitter/join" method="POST">
					<fieldset>
						<legend><i class="fa fa-twitter-square"></i>&nbsp;&nbsp;트위터로 회원가입</legend>
						...
						<div class="form-actions-white">
							...
							<i class="fa fa-twitter-square icon-white"></i>&nbsp;&nbsp;가입하기
							</button>
						</div>
						<input name="twitterID" type="hidden" value = "${twitterID}">
