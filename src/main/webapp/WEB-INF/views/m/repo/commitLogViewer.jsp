       ...
       <div data-role="content">
					...
					<tbody>
						<tr>
							...
							<td class="none-top-border post-top-title"><a rel='external' class="none-color" href="/repo/${repo.name}/commitlog-viewer/commit:${fn:substring(gitCommitLog.commitLogID,0,8)}">
							...
							<a rel="external"	href="/repo/${repo.name}/browser/commit:${fn:substring(gitCommitLog.commitLogID,0,8)}">
									<span class="span-button"> 
									<i class="icon-eye-open icon-white"></i>
										<p class="p-button">소스</p>
									</span>
							</a>
							<a class = "full-content" rel="external"	href="/repo:${repo.name}-${fn:substring(gitCommitLog.commitLogID,0,8)}.zip"">
										<span class="span-button"> 
