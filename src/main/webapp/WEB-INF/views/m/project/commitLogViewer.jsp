			 ...
			 <table class="table table-hover">
					<tbody>
						<tr>
							...
							<td style="width: 340px;" class="none-top-border post-top-title"><a rel='external' class="none-color" href="/project/${project.name}/commitlog-viewer/commit:${fn:substring(gitCommitLog.commitLogID,0,8)}">
							...
							href="/project:${project.name}-${fn:substring(gitCommitLog.commitLogID,0,8)}.zip"">
										<span class="span-button"> 
