...
<%@ include file="/WEB-INF/panel/projectPanel.jsp"%>
       ...
       <c:forEach items="${project.adminWeavers}" var="adminWeaver">
       		<tr><td class='td-post-writer-img'>
<img src='${adminWeaver.getImgSrc()}'></td>
