			...
			<div class="row">
				<div class="span12">
					<ul class="nav nav-tabs pull-left" id="myTab">
						<li id="age-desc"><a
							href="/admin/lecture<c:if test="${tagNames != null }">/tags:${tagNames}</c:if>/sort:age-desc/page:1">전체</a></li>
						<li id="teach"><a
							href="/admin/lecture<c:if test="${tagNames != null }">/tags:${tagNames}</c:if>/sort:teach/page:1">개설한 강의</a></li>
						<li id="join"><a
							href="/admin/lecture<c:if test="${tagNames != null }">/tags:${tagNames}</c:if>/sort:join/page:1">수강중인 강의</a></li>
					</ul>
					<div class="navbar navbar-inverse">
						<ul style="border-bottom: 0px;" class="nav pull-right">
							<li class="dropdown"><button
								class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
								<i class=" fa fa-university"></i> 강의<b class="caret"></b></button>
